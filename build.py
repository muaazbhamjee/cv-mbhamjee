...
Builds all LaTeX documents in the repository.
  ...
  Output locations
  ────────────────
  Root PDFs  — working copies, ignored by Git, rebuilt on demand.
  docs/PDFs  — publishable copies tracked by Git for GitHub Pages.
               Commit and push docs/ whenever you want to update
               your public site.
...
Workflow to update publications (CV):
    ...
    3. Working PDF:    cv_bhamjee.pdf
       Publishable:    docs/cv_bhamjee.pdf

Workflow to publish to GitHub Pages:
    git add docs/
    git commit -m "Publish updated PDFs"
    git push
"""
...
def compile_latex(tex_path, label):
    ...
    print(f"  ✓  docs/{pdf_name}  (GitHub Pages copy)")
